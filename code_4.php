...
<div id="histoire">
    ...
    <div id="indice">
        ...
        <p><a href="/code_4.php?indices=1#indice">Voir l'indice 1</a></p>
        <?php } else {
            ...
            if ($indice === 1) {
                echo '<p><a href="/code_4.php?indices=2#indice">Voir l\'indice 2</a></p>';
            }

            if ($indice === 2) {
                echo '<p><a href="/code_4.php?indices=3#indice">Voir la solution</a></p>';
            }
        } ?>
    </div>
</div>
...
<div id="propositions">
    ...
    <ul>
        <li>
            <p>
                <form method="post" action="enigme_4.php">            
